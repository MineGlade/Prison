...
public class DesertC extends DesertLevel {
	...
	public PrisonMine getMine() {
		return new PrisonMineFactory(this.getWorld(), 0, 0, 0, 0, 0, 0, Material.SAND)
				.addBlock(Material.SAND, 1, 0.15f)
				.addBlock(Material.GRAVEL, 0, 0.03f)
				.addBlock(Material.SANDSTONE, 0, 0.055f)
				.addBlock(Material.SANDSTONE, 1, 0.065f)
				.addBlock(Material.SANDSTONE, 2, 0.075f)
				.addBlock(Material.WEB, 1, 0.015f)
				.addBlock(Material.LOG_2, 0, 0.14f)
				.addBlock(Material.LEAVES_2, 0, 0.12f)
				.addBlock(Material.RED_SANDSTONE, 0, 0.06f)
				.addBlock(Material.RED_SANDSTONE, 1, 0.07f)
				.addBlock(Material.RED_SANDSTONE, 2, 0.08f)
				.create();
	}
