...
public class FarmD extends FarmLevel {
	...
	public PrisonMine getMine() {
		return new PrisonMineFactory(this.getWorld(), 10, 43, 7, -10, 63, 27, Material.DIRT)
				...
				.addBlock(Material.WOOD, 0, 0.035f)
				.addBlock(Material.WOOD, 2, 0.03f)
				.addBlock(Material.WOOD, 1, 0.035f)
				.addBlock(Material.WOOD, 3, 0.035f)
				.addBlock(Material.WOOD, 4, 0.03f)
				.addBlock(Material.WOOD, 5, 0.025f)
				.addBlock(Material.LOG, 0, 0.02f)
				.addBlock(Material.LOG, 2, 0.015f)
				.addBlock(Material.LOG, 1, 0.01f)
				.create();
	}
