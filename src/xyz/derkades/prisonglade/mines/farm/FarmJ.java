...
public class FarmJ extends FarmLevel {
	...
	public PrisonMine getMine() {
		return new PrisonMineFactory(this.getWorld(), 10, 43, 7, -10, 63, 27, Material.DIRT)
				...
				.addBlock(Material.WOOD, 0, 0.005f)
				.addBlock(Material.WOOD, 1, 0.005f)
				.addBlock(Material.WOOD, 3, 0.005f)
				.addBlock(Material.WOOD, 4, 0.005f)
				.addBlock(Material.WOOD, 5, 0.005f)
				.addBlock(Material.LOG, 0, 0.04f)
				.addBlock(Material.LOG, 2, 0.04f)
				.addBlock(Material.LOG, 1, 0.04f)
				.addBlock(Material.LOG, 3, 0.035f)
				.addBlock(Material.LOG_2, 0, 0.03f)
				.addBlock(Material.LOG_2, 1, 0.025f)
				.create();
